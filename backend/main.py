...
from polygon_tools.crypto_trades import register_polygon_crypto_trades
...
# Polygon MCP tools
register_polygon_news(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_ticker_details(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_price_data(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_conditions(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_daily_open_close(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_exchanges(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_grouped_daily(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_previous_close(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_snapshots(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_snapshot_ticker(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_snapshot_book(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_aggregates(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_last_trade(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_tickers(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_market_holidays(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_market_status(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_gainers_losers(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_ema(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_macd(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_rsi(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_sma(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
register_polygon_crypto_trades(mcp, polygon_client, CSV_DIR, REQUESTS_DIR)
