...
def register_polygon_crypto_ema(local_mcp_instance, local_polygon_client, csv_dir, requests_dir):
    ...
    def polygon_crypto_ema(
        ...
        """
        logger.info(f"polygon_crypto_ema invoked by {requester}: ticker={ticker}, timespan={timespan}, window={window}")
