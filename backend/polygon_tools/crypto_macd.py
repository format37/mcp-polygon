...
def register_polygon_crypto_macd(local_mcp_instance, local_polygon_client, csv_dir, requests_dir):
    ...
    def polygon_crypto_macd(
        ...
        """
        logger.info(f"polygon_crypto_macd invoked by {requester}: ticker={ticker}, timespan={timespan}")
        ...
        try:
            ...
            log_request(
                ...
                requester=requester,
                tool_name="polygon_crypto_macd",
                input_params={"ticker": ticker, "timespan": timespan, "short_window": short_window, "long_window": long_window, "signal_window": signal_window, "series_type": series_type, "limit": limit, "timestamp_gte": timestamp_gte, "timestamp_lte": timestamp_lte},
